...
import com.example.myproject.databinding.FragmentAttrAudioBinding;
...
public class AttrAudioFragment extends Fragment {
    ...
    FragmentAttrAudioBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAttrAudioBinding.inflate(inflater, container, false);
        View view = binding.getRoot();


        // initialize media player
        mediaPlayer = MediaPlayer.create(getContext(), R.raw.zuhd);
